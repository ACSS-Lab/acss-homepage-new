...
const pages = defineCollection({
  ...
  schema: z.discriminatedUnion('page', [
    ...
    z.object({
      ...
      highlights: z.object({
        title: z.string(),
        count: z.number().int().min(3).max(6).default(6),
        link: cta,
        kinds: z.object({ paper: z.string(), award: z.string(), grant: z.string(), media: z.string() }),
        selected: z.string(),
      }),
      gallery: z.object({
        title: z.string(),
        ...
        intervalMs: z.number().int().min(1000).max(30000).default(3000),
        link: cta,
    ...
    z.object({
      ...
      labels: z.object({
        ...
        joined: z.string().includes('{date}'),
        incoming: z.string().includes('{date}'),
        terms: z.object({ spring: z.string(), summer: z.string(), fall: z.string(), winter: z.string() }),
      }),
      interns: z.object({ title: z.string(), note: z.string() }),
      alumni: z.object({ title: z.string(), note: z.string() }),
